[[def: KEL-backed-data, KEL backed data]]

~ [[ref: KEL]] backed data in `did:webs` provides the highest level of data
...
~    watched by agents ([[ref: watcher]]) of the verifiers. The information is
...
~ More detail:
~    [WebOfTrust glossary](https://weboftrust.github.io/WOT-terms/docs/glossary/kel-backed-data).
