...
~    transferable AID supports key rotation using a key [[ref: pre-rotation]]
~    mechanism that enables the AID to persist in spite of the evolution of its
~    [[ref:key state]].

~ More:
~    [KERISuite glossary](https://weboftrust.github.io/WOT-terms/docs/glossary/autonomic-identifier).
